...
def predictVideo(detectorfile,embeddingmodelfile,recognizerfile,labelencoderfile):
...
if __name__ == '__main__':
	predictVideo('face_detection_model','openface_nn4.small2.v1.t7','output/recognizer.pickle','output/le.pickle')
